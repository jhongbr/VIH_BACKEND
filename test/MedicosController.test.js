...
const usuariosController = require("../src/controllers/MedicosController")
const usuariosRepository = require("../src/repository/MedicosRepo")
...
it('should save the preguntaController successfully', async () => {
        ...
        sinon.stub(usuariosRepository, 'createMedicos').resolves(resService);
