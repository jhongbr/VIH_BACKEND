...
const usuariosController = require("../src/controllers/CitasController")
const usuariosRepository = require("../src/repository/CitasRepo")
...
it('should save the preguntaController successfully', async () => {
        ...
        sinon.stub(usuariosRepository, 'createCitas').resolves(resService);
